...
{
    public partial class SEChart : Form
    {
        public SEChart()
        {
            InitializeComponent();
        ...
        private void SEChart_Load(object sender, EventArgs e)
        {
        ...
        {
            string vszpath = Main.currentdir + "\\" + "SE_Chart_VSZ.jpeg";
            string rsspath = Main.currentdir + "\\" + "SE_Chart_RSS.jpeg";
            try
            {
                this.chart1.SaveImage(vszpath, ChartImageFormat.Jpeg);
                this.chart2.SaveImage(rsspath, ChartImageFormat.Jpeg);
                MessageBox.Show("OAMP Chart Image Saved", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
