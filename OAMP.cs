...
{
    public partial class OAMP : Form
    {
        public OAMP()
        {
            InitializeComponent();
        ...
        private void OAMP_Load(object sender, EventArgs e)
        {
        ...
        {
            string vszpath = Main.currentdir + "\\" + "OAMP_Chart_VSZ.jpeg";
            string rsspath = Main.currentdir + "\\" + "OAMP_Chart_RSS.jpeg";
            try
            {
